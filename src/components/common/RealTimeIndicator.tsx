...
export function RealTimeIndicator(props: RealTimeIndicatorProps): JSX.Element {
  ...
  return (
    <div className="flex items-center gap-2 rounded-full border border-slate-200/60 bg-slate-950 px-4 py-2 text-xs font-medium text-white shadow-[0_18px_34px_rgba(15,23,42,0.18)]">
